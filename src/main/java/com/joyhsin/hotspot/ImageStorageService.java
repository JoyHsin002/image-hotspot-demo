...
public class ImageStorageService {
  ...
  public ImageStorageService(AppProperties props) throws IOException { root=props.dataDir().toAbsolutePath().normalize().resolve("uploads"); Files.createDirectories(root); }
